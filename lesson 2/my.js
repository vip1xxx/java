...
const time = parseInt(prompt("Введіть число від 0 до 59:"));

if (time >= 0 && time <= 14) {
    console.log("Число належить першій чверті години");
} else if (time >= 15 && time <= 29) {
    console.log("Число належить другій чверті години");
} else if (time >= 30 && time <= 44) {
    console.log("Число належить третій чверті години");
} else {
    console.log("Число належить четвертій чверті години");
}

// - У змінній day дано якесь число від 1 до 31. Потрібно визначити, у яку половину(декаду) місяця потрапляє це число (у першу, другу чи третю).
const day = parseInt(prompt("Введіть число від 1 до 31:"));

if (day >= 1 && day <= 10) {
    console.log("Число належить до першої декади місяця");
} else if (day >= 11 && day <= 20) {
    console.log("Число належить до другої декади місяця");
} else if (day >= 21 && day <= 31) {
    console.log("Число належить до третьої декади місяця");
} else {
    console.log("Введене число не входить у діапазон від 1 до 31");
}
